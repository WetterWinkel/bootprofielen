...
export async function loader({request}: LoaderFunctionArgs) {
  ...
  return liquid(`${styles}<main class="ww-terms">
    ...
    <p class="ww-summary"><strong>Samenvatting:</strong> een advertentie kost € 14,95 inclusief btw en staat na betaling en goedkeuring 30 kalenderdagen online. WetterWinkel biedt uitsluitend advertentieruimte en is geen partij bij koop, inspectie, betaling of eigendomsoverdracht.</p>
    <h2>1. Plaatsing en looptijd</h2><p>De looptijd begint op het moment dat WetterWinkel de betaalde advertentie goedkeurt en publiceert. WetterWinkel mag een advertentie vóór of na publicatie controleren, aanpassing vragen of verwijderen wanneer deze onjuist, misleidend, onrechtmatig of strijdig met deze voorwaarden is.</p>
    ...
    <h2>4. Betaling en afwijzing</h2><p>De advertentieprijs wordt via Shopify afgerekend. Als WetterWinkel een advertentie vóór publicatie definitief afwijst, wordt de advertentieprijs terugbetaald. Na publicatie is geen restitutie verschuldigd bij verkoop vóór het einde van de looptijd of verwijdering wegens overtreding, behalve voor zover dwingend recht anders bepaalt.</p>
